...
namespace Server.Gumps
{
    public class IceGMTool : Gump
    {
        ...
        public IceGMTool(Mobile from): base(0, 0)
        {
            ...
            AddPage(6);
            AddBackground(139, 84, 119, 21, 9200);
            AddLabel(158, 85, 267, "GM Tool");
			...
			{
                AddButton(141, 61, 2093, 2093, 37, GumpButtonType.Reply, 0);
                AddButton(170, 61, 2093, 2093, 31, GumpButtonType.Reply, 0);
            	AddButton(199, 61, 2093, 2093, 29, GumpButtonType.Reply, 29);
           	 	AddButton(228, 62, 2093, 2093, 0, GumpButtonType.Page, 7);
                AddLabel(145, 62, 1259, "VE");
                AddLabel(174, 62, 1259, "Pr");
                AddLabel(203, 62, 1259, "Ad");
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 36:
                    ...
                    break;
                case 37:
                    CommandSystem.Handle(from, String.Format("{0}Viewequip", prefix));
                    from.SendMessage(2125, "Equip items");
                    from.SendGump(new IceGMTool(from));
                    break;
                case 38:
